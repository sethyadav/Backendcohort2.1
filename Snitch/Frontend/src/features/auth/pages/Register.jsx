...
//   return (
//     <div className="min-h-screen bg-[#131313] text-[#e5e2e1] flex items-center justify-center p-6 font-sans">
//       <div className="w-full max-w-md bg-[#131313] flex flex-col items-center">
//         {/* Header */}
//         <div className="w-full text-center mb-12">
//           <h1 className="text-4xl text-[#ffe4af] font-light mb-2 tracking-wide text-left">
//             Create an Account.
//           </h1>
//           <p className="text-[#d4c5ab] text-left text-sm mt-4">
//             Join us to experience seamless, premium commerce.
//           </p>
//         </div>
...
//             className="w-full bg-[#2a2a2a] text-[#e5e2e1] placeholder-[#d4c5ab] px-5 py-5 rounded-lg border-none outline-none focus:bg-[#353534] focus:ring-1 focus:ring-[#ffc107] transition-colors duration-300"
//             required
//           />
...
//               onChange={handleChange}
//               className="w-6 h-6 bg-[#2a2a2a] border-none rounded text-[#ffc107] focus:ring-[#ffc107] focus:ring-offset-0 cursor-pointer accent-[#ffc107]"
//             />
//             <label htmlFor="isSeller" className="text-[#e5e2e1] text-lg cursor-pointer">
...
//           <button
//             type="submit"
//             className="w-full mt-6 bg-gradient-to-r from-[#ffe4af] to-[#ffc107] text-[#3f2e00] font-semibold text-lg px-6 py-5 rounded-lg hover:from-[#ffdf9e] hover:to-[#fabd00] transition-all duration-300 shadow-[0_4px_32px_rgba(255,193,7,0.15)]"
//           >
//             Create Account
//           </button>
...
//         <p className="mt-12 text-[#d4c5ab] text-sm">
//           Already have an account? <a href="/login" className="text-[#ffe4af] hover:text-[#ffc107] transition-colors font-semibold">Sign In</a>
//         </p>
//       </div>
//     </div>
//   );
